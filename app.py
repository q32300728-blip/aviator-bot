...
# পৃষ্ঠার লেআউট এবং প্রিমিয়াম স্টাইল এসটিএম কনফিগারেশন
st.set_page_config(page_title="Pro Elite OTC AI Trading Terminal", layout="wide", page_icon="📈")

# কাস্টম CSS দিয়ে স্টাইল পিনপেন এবং প্রিমিয়াম লুক
st.markdown("""
<style>
...
.signal-up { background-color: linear-gradient(135deg, #00b09b, #96c93d); padding: 15px; border-radius: 12px; color: white; text-align: center; font-size: 20px; font-weight: bold; }
...
# নিচে রেন্ডার ড্যাশবোর্ড থেকে এপিআই কী লোড করা
...
# জেমিনির সঠিক ও আপডেট মডেল সেট করা হলো (ত্রুটি এড়ানোর জন্য gemini-1.5-flash ব্যবহার করা হয়েছে)
