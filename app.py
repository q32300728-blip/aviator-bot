...
# জেমিনির লেটেস্ট সাজেস্টেড মডেল কনফিগারেশন
...
with col2:
    ...
    2. **মার্কেট কারেন্ট ও অ্যালগরিদম (Market Condition & Active Buyers/Sellers):** Are buyers or sellers in current control?
    3. **প্রাইস অ্যাকশন পয়েন্ট ও ওটিসি অ্যালগরিদম (Price Action & OTC Algorithm):** Which OTC manipulation or trap is active?
    ...
    if st.button("⚡ ফাস্ট অ্যানালাইসিস শুরু করুন (২০ সেকেন্ড)"):
        if uploaded_file is not None:
            with st.spinner("এআই ওটিসি চার্ট স্ক্যান করছে, ফলাফল তৈরি হচ্ছে..."):
                try:
                    response = model.generate_content([system_prompt, image])
                    result_text = response.text
                except Exception as e:
                    result_text = f"এআই রেসপন্স জেনারেট করতে সমস্যা হয়েছে: {str(e)}"
