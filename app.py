...
st.markdown("""
    ...
    .metric-title { color: #00ffa3; font-weight: bold; }
    </style>
...
# দ্রুত রেসপন্সের জন্য ফ্ল্যাশ মডেল ব্যবহার (২০ সেকেন্ডের মধ্যে নিখুঁত আউটপুটের জন্য সেরা)
...
with st.sidebar:
    ...
    st.markdown("---")
    st.info("💡 টিপস: ওটিসি মার্কেটের ১-মিনিটের ক্যান্ডেলস্টিক চার্ট, রিউজেবল লেভেল ও ভলিউম সহ পরিষ্কার স্ক্রিনশট আপলোড করুন।")
...
if uploaded_file is not None:
    ...
    with col2:
        ...
        # পৃথিবীর শীর্ষস্থানীয় প্রাইস অ্যাকশন ও ওটিসি অ্যালগরিদম ট্র্যাপ ট্র্যাকিং প্রম্পট
        system_prompt = f"""
        ...
        if st.button("🚀 ২০ সেকেন্ডে প্রো-লেভেল অ্যানালাইসিস শুরু করুন") or auto_refresh:
            ...
            while True:
                ...
                with st.status("⏳ পরবর্তী ২০ সেকেন্ডের স্মার্ট স্ক্যানের জন্য অপেক্ষা করা হচ্ছে...", expanded=False) as status:
                    for remaining in range(20, 0, -1):
                        status.update(label=f"পরবর্তী আপডেট হতে বাকি: {remaining} সেকেন্ড...")
                        time.sleep(1)
                    status.update(label="নতুন ক্যান্ডেল ও ট্র্যাপ স্ক্যান হচ্ছে!", state="complete")
