...
async def main():
    ...
    while True:
        try:
            # ডাইনামিক সেশন ও WebSocket URL ফেচ করা
            ...
            # পার্মানেন্ট WebSocket কানেকশন ওপেন রাখা
            async with websockets.connect(ws_url, ping_interval=20, ping_timeout=20) as websocket:
                ...
                # নিরবচ্ছিন্নভাবে লাইভ ডেটা রিড করার লুপ
                async for message in websocket:
                    await process_game_data(message)
                    
        except Exception as e:
            print(f"⚠️ কানেকশন ড্রপ করেছে বা ত্রুটি ঘটেছে ({e})। ৫ সেকেন্ডের মধ্যে স্বয়ংক্রিয়ভাবে রি-কানেক্ট করা হচ্ছে...")
